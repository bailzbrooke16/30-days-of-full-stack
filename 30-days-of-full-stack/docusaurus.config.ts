...
const config: Config = {
  title: '30 Days of Full Stack',
  tagline: 'Go from newbee to proficient in full stack technologies like .net, sql and angular',
  ...
  projectName: '30 days of full stack', // Usually your repo name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Eish no copy right on this one.`,
    },
    prism: {
